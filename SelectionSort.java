...
public class SelectionSort implements Comparable<Integer> {
    ...
    void display ()
    {
        System.out.println("\n\nCalled from SelectionSort - Ascending.");
