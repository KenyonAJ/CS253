...
public class BubbleSort2 implements Comparable<Integer> {
    ...
    void display ()
    {
        System.out.println("\n\nCalled from BubbleSort - Descending.");
