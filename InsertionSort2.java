...
public class InsertionSort2 implements Comparable<Integer> {
    ...
    void display ()
    {
        System.out.println("\n\nCalled from InsertionSort - Descending.");
